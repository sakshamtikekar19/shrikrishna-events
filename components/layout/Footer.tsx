        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-16 mb-16">
          <div className="space-y-6">
            ...
            <p className="text-secondary-text text-sm leading-relaxed font-body opacity-70 italic">
              Crafting divine celebrations and royal masterpieces since 2010.
            </p>
            <div className="flex space-x-4">
              <a
                ...
                className="w-9 h-9 rounded-full border border-royal-gold/15 flex items-center justify-center text-royal-gold/50 hover:bg-royal-gold hover:text-background transition-all duration-300"
              >
                <FaInstagram size={16} />
              </a>
            </div>
